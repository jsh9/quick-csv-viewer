export const VIEW_TYPE = 'quickCsvViewer.viewer';
export const SETTINGS_SECTION = 'quickCsvViewer';
export const SAMPLE_CSV_PATHS = [
...
export const FILE_RELOAD_DEBOUNCE_MS = 150;
